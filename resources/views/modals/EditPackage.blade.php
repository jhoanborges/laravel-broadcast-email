<div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
 ...
 <div class="row">
     <div class="col">
         ...
         <input name="long" type="text" class="form-control long"  required  maxlength="191">
         <span class="error" role="alert"> </span>
     </div>
     <div class="col">
         <label for="height" class="required">Ancho:</label>
         <input name="height" type="text" class="form-control height" required  maxlength="191">
         <span class="error" role="alert"> </span>
     </div>

     <div class="col">
         <label for="width" class="required">Largo:</label>
         <input name="width" type="text" class="form-control width"  required  maxlength="191">
         <span class="error" role="alert"> </span>
     </div>
     ...
     <div class="col">
         ...
         <input name="unit" type="text" class="form-control unit"  required  maxlength="191">
         <span class="error" role="alert"> </span>
     </div>
 ...
 <div class="row">
  ...
  <div class="col">
     ...
     <input name="weight" type="text" class="form-control weight" required  maxlength="191">
     <span class="error" role="alert"> </span>
 </div>

 <div class="col">
     <label for="unit_weight" class="required">Unidad:</label>
     <input name="unit_weight" type="text" class="form-control unit_weight"  required  maxlength="191">
     <span class="error" role="alert"> </span>
 </div>

    <div class="col">
      <label for="public" class="required">Público</label>
      <select required class="form-control public"  name="public">
