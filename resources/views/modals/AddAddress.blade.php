<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <form id="form" method="post"  role="form"   accept-charset="utf-8">
   ...
   <div class="col">
       ...
       <input name="phone" type="text" class="form-control" id="phone"  required  maxlength="191">
       <span class="error" role="alert"> </span>
   </div>
...
<div class="row">
  <div class="col">
   ...
   <textarea name="address" type="text" class="form-control" id="address"  required  maxlength="1000"></textarea>
   <span class="error" role="alert"> </span>
</div>
...
<div class="row">
    ...
    <div class="col">
       ...
       <input name="postal_code" type="text" class="form-control" id="postal_code"  maxlength="191">
       <span class="error" role="alert"> </span>
   </div>
...
<div class="row">
 ...
 <div class="col">
  ...
  <select required class="form-control" id="estate"  name="estate">
      <option disabled selected value="">Seleccione una opción</option>
