...
<section class="dashboard-counts no-padding-bottom">
    <div class="container-fluid dash-content d-flex">
        <h1  class="darkblue  mt-1">Clientes Plataforma</h1>
...
{  "render" : function (data, type, row) {
    return row.name + (row.apellidos ? row.apellidos : '');
},
},
...
{"data": "phone" },
{  "render" : function (data, type, row) {
    if(row.store_url.length){
        return row.store_url.substring(0,60)+'...';
